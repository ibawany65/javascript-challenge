// Set variables to the elements of the DOM
...
// Configure Event handler functions
...
// Set renderTable function
function renderTable() {
    // clear previously rendered table
    $tbody.innerHTML = "";

    // Determine number of records to be rendered
...
// Renders page on initial launch
renderTable();
